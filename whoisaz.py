...
header= {"Accept-Encoding": "gzip, deflate",
	 ...
	 "Content-Length": "7", "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8" ,
	 "Referer": "http://whois.az/cgi-bin/whois.cgi",
	 "Content-Type": "application/x-www-form-urlencoded", 
	 "Host": "whois.az", "User-Agent": "MMozilla/5.0 "}
